...
namespace projettaquin
{
    ...
    abstract public class GenericNode
    {
       // protected string Name;              // DOIT ETRE UNIQUE POUR CHAQUE genericnode !!
        ...
        public double Estimation() { return HCost; }

        public void SetEstimation(double h) { HCost = h; }
        ...
        public void SetNoeud_Parent(GenericNode g) 
       {
        ...
        public void calculCoutTotal()  { TotalCost = GCost + HCost; }
        ...
        // a cause de la duplication de la classe Emplacement : redéfinition : validé par encadrant
        public abstract bool EndState(Emplacement final);
        public abstract bool EndState(Emplacement_Q3 final);

        public abstract List<GenericNode> GetListSucc();

        // a cause de la duplication de la classe Emplacement : redéfinition : validé par encadrant
        public abstract void CalculeHCost(Emplacement final);
