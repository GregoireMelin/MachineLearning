...
namespace projettaquin
{
    public class Graph
    {
        ...
        //Constructeur de Graph a partir du tableau de l'entrepot
        public Graph(Emplacement xF,Emplacement d)
        {
            depart = d;
            destination = xF;           
        }
        ...
        public List<GenericNode> RechercheSolutionAEtoile()
        {
            ...
            GenericNode N = depart;
            L_Ouverts.Add(depart);

            // tant que le noeud n'est pas terminal et que ouverts n'est pas vide
            while (L_Ouverts.Count != 0 && N.EndState(destination) == false)
            {
